...
export const SERMONS: Sermon[] = [
  ...
  //   - Entries bucketed into "Standalone Messages" are one-off messages
  //     (topical Psalms, Advent one-offs, Easter, year-end) that don't
  //     belong to a multi-week run -- all preached by our own staff
  //     pastors, not visiting speakers, so this is NOT a "guest" bucket.
  {
...
export const SERIES_META: Record<string, {
  ...
  "standalone-messages": {
    description: "Standalone messages that don't belong to a multi-week series — topical one-offs, Advent, Easter, and year-end.",
  },
  "who-is-jesus-2025": {
