    ...
    <div className="min-h-screen" style={{ background: "linear-gradient(180deg, #0a1628 0%, #07101e 100%)" }}>
      ...
      <section className="py-12 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="font-condensed font-800 text-white text-3xl mb-8">
            Why a Life Group?
          </h2>
          <div className="grid sm:grid-cols-2 gap-5">
            {WHYS.map((w) => (
              <div key={w.title} className="glass rounded-2xl p-7">
                <h3 className="font-condensed font-700 text-white text-xl mb-2">{w.title}</h3>
      ...
      <section className="py-12 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="glass-md rounded-2xl p-8 md:p-10 grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="font-condensed font-800 text-white text-2xl mb-4">When Do They Meet?</h2>
              <div className="space-y-3">
                <div className="glass rounded-xl p-4">
                  <p className="text-gold text-xs font-semibold tracking-widest uppercase mb-1">Sunday Mornings</p>
                  <p className="text-white font-semibold">9:45 AM</p>
                  <p className="text-white/55 text-sm">On campus — between services</p>
                </div>
                <div className="glass rounded-xl p-4">
                  <p className="text-gold text-xs font-semibold tracking-widest uppercase mb-1">Throughout the Week</p>
                  <p className="text-white font-semibold">In Homes Across Chattanooga</p>
                  <p className="text-white/55 text-sm">Evenings vary by group</p>
                </div>
              </div>
            </div>
            <div>
              <h2 className="font-condensed font-800 text-white text-2xl mb-4">What Happens?</h2>
