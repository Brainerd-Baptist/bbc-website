              ...
              <div className="p-8 md:p-10 grid md:grid-cols-[auto_1fr_auto] gap-6 md:gap-10 items-start">
                ...
                {href && (
                  <div className="shrink-0 self-center">
                    <Link
                      href={href}
                      className="font-condensed font-700 tracking-wide uppercase text-sm border rounded-full px-5 py-2.5 transition inline-flex items-center gap-2 whitespace-nowrap identity-ink identity-border"
                      style={inkVars(ink)}
                    >
                      Learn More
