    ...
    <div className="min-h-screen bg-surface">
      ...
      <section className="py-24 px-6 bg-surface">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
          ...
          {/* Hours card */}
          <div className="rounded-2xl p-8 border border-border" style={{ background: "var(--surface-sunken)" }}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="font-condensed font-800 text-fg" style={{ fontSize: "1.2rem" }}>
                Hours of Operation
              </h3>
            </div>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-fg-muted leading-relaxed mb-8">
              ...
              Call us at{" "}
              <a href="tel:4236434978" className="font-semibold" style={{ color: "var(--fg)" }}>
                (423) 643-4978
              </a>.
            </p>
            <a
      ...
      <section className="py-24 px-6" style={{ background: "var(--surface-sunken)" }}>
        <div className="max-w-5xl mx-auto">
          <div className="mb-10 text-center">
            ...
            <p className="text-fg-muted mt-4 max-w-md mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-10">
            {[
              ...
              <div key={label} className="rounded-2xl p-6 border border-border" style={{ background: "var(--surface-sunken)" }}>
                ...
                <h3 className="font-condensed font-800 text-fg mb-2" style={{ fontSize: "1.1rem" }}>
                  {label}
                </h3>
