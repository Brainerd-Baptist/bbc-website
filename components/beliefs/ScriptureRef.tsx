  ...
  return (
    <span className="relative inline-block">
      <button
        ...
        type="button"
        onClick={handleClick}
        className="text-xs font-semibold tracking-wide underline decoration-dotted underline-offset-2 transition-opacity hover:opacity-70 focus-visible:ring-2 focus-visible:ring-accent rounded"
