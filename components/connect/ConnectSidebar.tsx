  ...
  return (
    <div className="space-y-5">
      ...
      <div className="glass rounded-2xl p-6">
        ...
        <p className="font-semibold text-fg mb-1">Brainerd Baptist Church</p>
      ...
      <div className="glass rounded-2xl p-6">
        ...
        <div className="space-y-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 text-fg-muted hover:text-accent-text transition-colors text-sm"
          >
          ...
          >
            <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
              <path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.95C5.12 20 12 20 12 20s6.88 0 8.59-.47a2.78 2.78 0 0 0 1.95-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z" /><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" style={{ fill: "var(--surface-raised)" }} />
            </svg>
            YouTube
          </a>
        </div>
      ...
      <div className="glass rounded-2xl p-6 border border-brand-cyan/20">
        ...
        <p className="font-semibold text-fg mb-2">Give Online</p>
        <p className="text-fg-muted text-xs leading-relaxed mb-4">
